...
class App(tkinter.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.frame_left = customtkinter.CTkFrame(
            master=self, width=200, height=App.HEIGHT - 40, corner_radius=0
        )
        self.frame_left.place(relx=0.32, rely=0.5, anchor=tkinter.E)

        self.frame_right = customtkinter.CTkFrame(
            master=self, width=420, height=App.HEIGHT - 40, corner_radius=0
        )
        ...
        self.frame_info = customtkinter.CTkFrame(
            master=self.frame_right, width=380, height=200, corner_radius=0
        )
        ...
        self.entry = customtkinter.CTkEntry(
            master=self.frame_right, width=120, height=28, corner_radius=0
        )
